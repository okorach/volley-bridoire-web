        ...
        <div class="row">
            <div class="mbr-table-md-up">
              <div class="mbr-table-cell mbr-right-padding-md-up mbr-valign-top col-md-6">
                  <div class="mbr-figure" ><img src="photos/joueurs/bubu.jpg"></div>
              </div>
              <div class="mbr-table-cell oko-player col-md-6 text-xs-center text-md-left">
                  <h3 class="mbr-section-title display-2">Reynald</h3>
                  <div class="lead">
                    <p>Surnom: Bubu<br>
					Poste préféré: Central<br>
					Régime: Strictement bio<br>
					Quoi d'autre? Fondateur du club, Boucles d'oreilles coté gauche, élu 3 fois Mister Gendarmerie de Savoie</p>
