        ...
        <div class="row">
            <div class="mbr-table-md-up">
              <div class="mbr-table-cell mbr-right-padding-md-up mbr-valign-top col-md-6">
                  <div class="mbr-figure" ><img src="photos/joueurs/kad.jpg"></div>
              </div>
              <div class="mbr-table-cell oko-player col-md-6 text-xs-center text-md-left">
                  <h3 class="mbr-section-title display-2">Grégory</h3>
                  <div class="lead">
                    <p>Surnom: Kad !<br>
					Poste préféré: Central<br>
					Acteur préféré: Le gars qui joue dans bienvenue chez les ch'tis, c'est quoi son nom déjà ?<br>
					Quoi d'autre? Trésorier en exercice</p>
