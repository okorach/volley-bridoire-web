        ...
        <div class="row">
            <div class="mbr-table-md-up">
              <div class="mbr-table-cell mbr-right-padding-md-up mbr-valign-top col-md-6">
                  <div class="mbr-figure" ><img src="photos/joueurs/taz.jpg"></div>
              </div>
              <div class="mbr-table-cell oko-player col-md-6 text-xs-center text-md-left">
                  <h3 class="mbr-section-title display-2">Philippe</h3>
                  <div class="lead">
                    <p>Surnom: Taz<br>
					Poste préféré: Aucun, il sait tout faire<br>
					Signe particulier: 47 ans de volley. A entraîné 28 équipes dans sa carrière.<br>
					Quoi d'autre ? <br>Parle plus vite que son ombre.<br>Qui a dit râleur ? Tu le cherches ou quoi !<br>Occasionnellement va faire des championnats de police inter-services de volley à l'autre bout du monde au frais du contribuable.</p>
