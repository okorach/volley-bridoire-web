...
<section class="mbr-section mbr-parallax-background" id="page4-msg-box7-0" style="background-image: url(photos/backgrounds/bg_joueur_passe.jpg); padding-top: 240px; padding-bottom: 240px;">
        ...
        <div class="row">
            <div class="mbr-table-md-up">
              <div class="mbr-table-cell mbr-right-padding-md-up mbr-valign-top col-md-6">
                  <div class="mbr-figure" ><img src="photos/joueurs/didier.jpg"></div>
              </div>
              <div class="mbr-table-cell oko-player col-md-6 text-xs-center text-md-left">
                  <h3 class="mbr-section-title display-2">Didier</h3>
                  <div class="lead">
                    <p>Surnom: Didier<br>
					Poste préféré: Pompier, Passeur<br>
					Quoi d'autre? Lâche régulièrement l'équipe pour aller sauver le monde et ses habitants aux 4 coins de la France, on lui ne veut pas à cause que c'est notre fournisseur offciel de rhum arrangés et d'alcools frelatés en tous genre, et pis c'est vrai aussi qu'il est le seul avec un minivan assez grand pour emmener toute l'équipe au fin fond de la Tarentaise</p>
					<br>
