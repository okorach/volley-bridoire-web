        ...
        <div class="row">
            <div class="mbr-table-md-up">
              <div class="mbr-table-cell mbr-right-padding-md-up mbr-valign-top col-md-6">
                  <div class="mbr-figure" ><img src="photos/joueurs/ben.jpg"></div>
              </div>
              <div class="mbr-table-cell oko-player col-md-6 text-xs-center text-md-left">
                  <h3 class="mbr-section-title display-2">Benoît</h3>
                  <div class="lead">
                    <p>Surnom: Ben<br>
					Poste préféré: Attaquant<br>
					Autre poste: Aucun, attaque ou rien!<br>
					Quoi d'autre? Animateur officiel dans les douches... et ailleurs: Heu tu la connais celle du... (Stop ca ne peux être que salace)</p>
